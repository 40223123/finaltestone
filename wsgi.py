...
#@-<<declarations>>
#@+others
#@+node:office.20150504185643.1: ** downloadlist_access_list
def downloadlist_access_list(files, starti, endi):
    ...
    return outstring
#@+node:office.20150504185717.1: ** sizeof_fmt
def sizeof_fmt(num):
...
#@+node:2014fall.20141212095015.1777: ** class Midterm
################# (3) 程式類別定義區
...
class Midterm(object):
    ...
    #@+others
    #@+node:amd.20150503182609.1: *3* __init__
    def __init__(self):
        ...
        if not os.path.isdir(download_root_dir+"tmp"):
            try:
                ...
                print("mkdir error")
    #@+node:amd.20150503173602.1: *3* index
    ...
    def index(self):
        ...
        <form method=POST action=mygeartest3>
            <input type=submit value=上下齒輪程式>
            </form>
        ...
        return outstring
    #@+node:amd.20150503183542.1: *3* spur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:amd.20150503183546.1: *3* spuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    #@+node:amd.20150503185058.1: *3* drawspur
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:amd.20150503185210.1: *3* drawspuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    '''
        ...
        return outstring
    #@+node:office.20150504093049.1: *3* cube
    @cherrypy.expose
    # W 為正方體的邊長
    def cube(self, W=10):
        outstring = '''
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150623111600.1: *3* mygeartest3
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest3(self , M=15, P=15,N1=15, N2=24,N3=11,N4=13,N5=15 ,N6=17):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    '''
        ...
        return outstring
    #@+node:office.20150504093053.1: *3* cubeaction
    @cherrypy.expose
    # W 為正方體邊長, 內定值為 10
    ...
    '''
        ...
        return outstring
    #@+node:office.20150504183254.1: *3* fileuploadform
    @cherrypy.expose
    ...
    '''
    #@+node:office.20150504183312.1: *3* fileaxupload
    @cherrypy.expose
    ...
    #@+node:office.20150504185417.1: *3* download_list
    @cherrypy.expose
    ...
    #@-others
#@+node:office.20150504190303.1: ** class Download
class Download:
    #@+others
    #@+node:office.20150504190303.2: *3* index
    @cherrypy.expose
